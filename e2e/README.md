...
| `scenarios/publish-stop-to-vod` (D)     | clean broadcaster stop → VOD finalize a reap window later                                                                                                                                                                                                                                                                                                                                                    |
| `scenarios/gateway-outage-viewer` (G)   | viewer gateway down → uploads unaffected                                                                                                                                                                                                                                                                                                                                                                     |
| `scenarios/engine-restart` (E)          | ⛔ not re-run live since the reconnect window; the reconnect may now resume the same topic, see its docblock                                                                                                                                                                                                                                                                                                 |
...
| `scenarios/reconnect-during-drain` (K)  | ⛔ does not hold since the reconnect window; see its own docblock                                                                                                                                                                                                                                                                                                                                            |
