...
| date | what it establishes | |
| --- | --- | --- |
| 2026-09-02 | [Registers three mechanisms for a capped in-tab node delivering nothing in 20s on a link that carries a segment in 0.63s: H1 hedge amplification at 3.0x or more, H2 idle load at 30% of the cap, H3 quick refusals, plus an instrument check that voids every capped figure if a 700 kbps cap does not hold idle inbound under 87.5 KB/s](in-tab-throttle-probe-prediction-2026-09-02.md) | 📋 plan |
