...
| date | what it establishes | |
| --- | --- | --- |
| 2026-09-02 | [⚠️ A reading of OUR client on OUR pinned weeb-3 0.0.329001 under CHROME'S emulated cap, and the owner ruled weeb-3 is not the suspect: under a 2800 kbps cap that combination pulls **1.9 to 2.9 segments' worth of bytes per segment** while it loads and about one more afterwards, sends 2.5 to 3.4x the request frames, completes at **54 to 71 KB/s** on a 350 KB/s link and leaves that link **31% to 51%** full; two retrievals at once are slower than two in sequence and leave 1.3 to 1.7 MB of late duplicates. Settled idle background is 2 KB/s, so H2 is out. 19 rows, replicated three per arm, **0 BZZ**](in-tab-throttle-probe-result-2026-09-02.md) |  |
