...
**As of 2026-09-03.** A living map from product functionality to the live end-to-end scenarios that
...
| weeb3 actually served the bytes (arm proof)                                                              | `weeb3ArmRefusal` in all ten in-browser viewer tests, V4 and V5 since 2026-09-04 with a whole-run ceiling of nine gateway reads, both proven live the same day at six reads each | in every in-browser sitting                                   |
